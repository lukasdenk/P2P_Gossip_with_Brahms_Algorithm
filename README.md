...
The `messaging` package consists of the `api` and `p2p` *sub*packages. They are seperated from the `api` and `p2p` *main* packages because their classes are also used outside the main packages.  
